...
export function NoChill_RosterApp() {
  ...
  return (
    <>
      ...
      <div className="RosterQuestionnaire_Content">
        <div className="Questionnaire animate fadeInDown delay">
          <SubmittedPopup
            className="Submitted_Container"
            isOpen={isSubmittedPopupVisible}
          >
            <h2 className="Popup_Text">Submission Successful!</h2>
          </SubmittedPopup>
          <Popup
            className="Submitting_Container"
            isOpen={isPopupVisible}
            onClose={() => setIsPopUpVisible(!isPopupVisible)}
          >
            <h2 className="Popup_Text">
              Your responses are being submitted...
            </h2>
          </Popup>
          <div className="RosterClassQuestionnaire">
            <h2 className="QuestionnaireTitle">Roster Registration</h2>
            ...
            >
              <div className="GenInfo">
                <div className="GenInfo_Question Name">
                  <h3 className="QuestionLabel">Your name?</h3>
                  <input
                    id="PlayerName_Input"
                    name="Player Name"
                    className="TextInput PlayerNameInput"
                    value={PlayersName}
